package com.gammel2012.yetanotherredstonegadgetsmod;

import com.gammel2012.yetanotherredstonegadgetsmod.providers.*;
import com.gammel2012.yetanotherredstonegadgetsmod.registers.ModBlocks;
import com.gammel2012.yetanotherredstonegadgetsmod.registers.ModCreativeTabs;
...
@Mod(YetAnotherRedstoneGadgetsMod.MODID)
public class YetAnotherRedstoneGadgetsMod
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "yetanotherredstonegadgetsmod";
    private static final Logger LOGGER = LogUtils.getLogger();

    // The constructor for the mod class is the first code that is run when your mod is loaded.
    // FML will recognize some parameter types like IEventBus or ModContainer and pass them in automatically.
    public YetAnotherRedstoneGadgetsMod(IEventBus modEventBus)
    {
        // Register the commonSetup method for modloading
        modEventBus.addListener(this::commonSetup);

        modEventBus.addListener(YetAnotherRedstoneGadgetsMod::gatherData);

        handleRegisters(modEventBus);

        // Register ourselves for server and other game events we are interested in.
        // Note that this is necessary if and only if we want *this* class (YetAnotherRedstoneGadgetsMod) to respond directly to events.
