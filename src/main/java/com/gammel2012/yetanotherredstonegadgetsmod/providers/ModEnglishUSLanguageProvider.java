...
public class ModEnglishUSLanguageProvider extends LanguageProvider {
    ...
    public ModEnglishUSLanguageProvider(PackOutput output) {
        super(output, YetAnotherRedstoneGadgetsMod.MODID, LOCALE);
    }
    ...
    protected void addTranslations() {
        ...
        // Mod name
        add("itemGroup.YetAnotherRedstoneGadgetsMod", "Yet Another Redstone Gadgets Mod (YARG)");

        // Creative tab
        add("itemGroup.YetAnotherRedstoneGadgetsMod.tab", "Yet Another Redstone Gadgets Mod");
