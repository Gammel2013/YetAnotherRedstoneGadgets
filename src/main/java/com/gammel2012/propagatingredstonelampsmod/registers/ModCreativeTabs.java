...
public class ModCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> REDSTONE_STUFF_TAB = CREATIVE_MODE_TABS.register("propagatingredstonelampsmod", () -> CreativeModeTab.builder()
